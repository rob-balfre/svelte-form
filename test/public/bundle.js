(function () {
	...
	/* src/Form.svelte generated by Svelte v2.16.1 */
	...
	function create_main_fragment$1(component, ctx) {
		...
		var if_block0 = (ctx.hasSubmitButton) && create_if_block_1$1(component, ctx);
		...
		return {
			...
			m(target, anchor) {
				...
				if (slot_content_default) {
					append(form, slot_content_default);
	...
	assign(Form.prototype, methods);

	/* test/src/examples/CustomFormElem.svelte generated by Svelte v2.16.1 */
	...
	function create_main_fragment$2(component, ctx) {
		var div, p, text0_value = ctx.value || 'undefined...', text0, text1, button;

		function click_handler(event) {
			component.handleRandomize(event);
		}
		...
		return {
			c() {
				...
				text1 = createText("\n    ");
				button = createElement("button");
				button.textContent = "Randomize value";
				addListener(button, "click", click_handler);
				div.className = "customFormElem";
			},
			...
			p(changed, ctx) {
				if ((changed.value) && text0_value !== (text0_value = ctx.value || 'undefined...')) {
	...
	function CustomFormElem(options) {
		init(this, options);
	...
	assign(CustomFormElem.prototype, proto);
	assign(CustomFormElem.prototype, methods$1);

	/* test/src/examples/Form1.svelte generated by Svelte v2.16.1 */
	...
	function create_main_fragment$3(component, ctx) {
		var h1, text1, div0, label0, text3, formelement0_updating = {}, text4, br0, text5, div1, label1, text7, formelement1_updating = {}, text8, br1, text9, div2, label2, text11, formelement2_updating = {}, text12, br2, text13, div3, label3, text15, formelement3_updating = {}, text16, br3, text17, text18, if_block1_anchor;
		...
		if (ctx.$form1Data.name !== void 0) {
			formelement0_initial_data.value = ctx.$form1Data.name;
			formelement0_updating.value = true;
		}
		var formelement0 = new FormElement({
			root: component.root,
			store: component.store,
			data: formelement0_initial_data,
			_bind(changed, childState) {
				var newStoreState = {};
				if (!formelement0_updating.value && changed.value) {
					ctx.$form1Data.name = childState.value;
					newStoreState.form1Data = ctx.$form1Data;
				}
				component.store.set(newStoreState);
				formelement0_updating = {};
			}
		});

		component.root._beforecreate.push(() => {
			formelement0._bind({ value: 1 }, formelement0.get());
		});

		var formelement1_initial_data = {
		 	belongsTo: "form1",
		 	name: "world",
		 	isRequired: true,
		 	minlength: "3",
		...
		if (ctx.$form1Data.world !== void 0) {
			formelement1_initial_data.value = ctx.$form1Data.world;
			formelement1_updating.value = true;
		}
		var formelement1 = new FormElement({
			root: component.root,
			store: component.store,
			data: formelement1_initial_data,
			_bind(changed, childState) {
				var newStoreState = {};
				if (!formelement1_updating.value && changed.value) {
					ctx.$form1Data.world = childState.value;
					newStoreState.form1Data = ctx.$form1Data;
				}
				component.store.set(newStoreState);
		...
		var formelement3_initial_data = {
		 	belongsTo: "form1",
		 	name: "custom",
		 	isRequired: true,
		 	component: ctx.CustomFormElem
		 };
		if (ctx.$form1Data.custom !== void 0) {
			formelement3_initial_data.value = ctx.$form1Data.custom;
			formelement3_updating.value = true;
		}
		var formelement3 = new FormElement({
			root: component.root,
			store: component.store,
			data: formelement3_initial_data,
			_bind(changed, childState) {
				var newStoreState = {};
				if (!formelement3_updating.value && changed.value) {
					ctx.$form1Data.custom = childState.value;
					newStoreState.form1Data = ctx.$form1Data;
				}
				component.store.set(newStoreState);
				formelement3_updating = {};
			}
		});

		component.root._beforecreate.push(() => {
			formelement3._bind({ value: 1 }, formelement3.get());
		});
		...
		var if_block0 = (ctx.$form1Data) && create_if_block_1$2(component, ctx);
		...
		return {
			c() {
				...
				label2.htmlFor = "magic";
				label3.htmlFor = "custom";
			},

			m(target, anchor) {
				insert(target, h1, anchor);
				insert(target, text1, anchor);
				append(form._slotted.default, div0);
				append(div0, label0);
				append(div0, text3);
				formelement0._mount(div0, null);
				append(form._slotted.default, text4);
				append(form._slotted.default, br0);
				append(form._slotted.default, text5);
				append(form._slotted.default, div1);
				append(div1, label1);
				append(div1, text7);
				...
				append(form._slotted.default, text13);
				append(form._slotted.default, div3);
				append(div3, label3);
				append(div3, text15);
				formelement3._mount(div3, null);
				append(form._slotted.default, text16);
				append(form._slotted.default, br3);
			...
			p(changed, _ctx) {
				ctx = _ctx;
				var formelement0_changes = {};
				if (!formelement0_updating.value && changed.$form1Data) {
					formelement0_changes.value = ctx.$form1Data.name;
					formelement0_updating.value = ctx.$form1Data.name !== void 0;
				}
				formelement0._set(formelement0_changes);
				formelement0_updating = {};

				var formelement1_changes = {};
				if (!formelement1_updating.value && changed.$form1Data) {
					formelement1_changes.value = ctx.$form1Data.world;
					formelement1_updating.value = ctx.$form1Data.world !== void 0;
				}
				...
				var formelement3_changes = {};
				if (changed.CustomFormElem) formelement3_changes.component = ctx.CustomFormElem;
				if (!formelement3_updating.value && changed.$form1Data) {
					formelement3_changes.value = ctx.$form1Data.custom;
					formelement3_updating.value = ctx.$form1Data.custom !== void 0;
				}
				formelement3._set(formelement3_changes);
				formelement3_updating = {};
				...
				if (ctx.$form1Data) {
					if (if_block0) {
						...
						if_block0.c();
						if_block0.m(text18.parentNode, text18);
					}
				} else if (if_block0) {
					if_block0.d(1);
					if_block0 = null;
	...
	function create_if_block_1$2(component, ctx) {
		...
		return {
			...
			p(changed, ctx) {
				if (changed.Object || changed.$form1Data) {
					each_value = ctx.Object.entries(ctx.$form1Data);
	...
	function create_each_block(component, ctx) {
		...
		return {
			...
			p(changed, ctx) {
				if ((changed.Object || changed.$form1Data) && text0_value !== (text0_value = ctx.key)) {
					setData(text0, text0_value);
				}

				if ((changed.Object || changed.$form1Data) && text2_value !== (text2_value = ctx.val)) {
	...
	function create_if_block$2(component, ctx) {
		...
		return {
			c() {
				h2 = createElement("h2");
				h2.textContent = "Form state:";
				text1 = createText("\n");
				p0 = createElement("p");
				text2 = createText("Form isValid: ");
				text3 = createText(text3_value);
				text4 = createText("\n");
				p1 = createElement("p");
				text5 = createText("Form isDirty: ");
				text6 = createText(text6_value);
				text7 = createText("\n");
				p2 = createElement("p");
				text8 = createText("Form hasSubmitted: ");
			...
			p(changed, ctx) {
				if ((changed.$forms) && text3_value !== (text3_value = ctx.$forms.form1.isValid)) {
					setData(text3, text3_value);
				}

				if ((changed.$forms) && text6_value !== (text6_value = ctx.$forms.form1.isDirty)) {
					setData(text6, text6_value);
				}

				if ((changed.$forms) && text9_value !== (text9_value = ctx.$forms.form1.hasSubmitted)) {
	...
	function Form1(options) {
		init(this, options);
		this._state = assign(assign(assign({ Object : Object }, this.store._init(["form1Data","forms"])), data$2()), options.data);
		this.store._add(this, ["form1Data","forms"]);
		this._intro = true;
	...
	assign(Form1.prototype, proto);
	assign(Form1.prototype, methods$2);
